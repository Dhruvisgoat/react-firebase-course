...
const StudentRecord = ({ student, updateStudent, deleteStudent,updateField,updateValue,setUpdateField,setUpdateValue }) => {
    ...
    return (
        <div className='studentCard'>
            ...
            <button className="btn btn-primary me-2" onClick={() => updateStudent(student.id, updateField, updateValue)}>Update</button>
